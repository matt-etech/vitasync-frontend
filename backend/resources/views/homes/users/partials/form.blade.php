<div>
    <section class="form-section">
        <div class="form-section-header">
            ...
            <p class="form-section-description">Identify the user and keep their contact details current.</p>
        </div>
        <div class="row g-3">
            <div class="col-md-6">
    ...
    <section class="form-section">
        <fieldset>
            <div class="form-section-header">
                ...
                <p class="form-section-description">Assign responsibility groups first. Direct permissions should only be added for exceptions.</p>
            </div>
            <div class="row g-3">
    ...
    <section class="form-section">
        <fieldset>
            <div class="form-section-header">
                ...
                <p class="form-section-description">Use direct permissions sparingly when a user needs access outside their role.</p>
            </div>
            <div class="row g-3">
